...
function oredictModSort(relatedOreDict as IOreDictEntry){
	if (!relatedOreDict.empty) {
		// save all items in separate array first
...
function fixMetals (
	...
	//make sure were not working with empty oredicts
	...
	// NOTE: this is why using oredict sort script first (priority) can enhance this scripts usefulness
