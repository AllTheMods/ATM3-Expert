...
recipes.addShaped("ctagiv", <advgenerators:eu_output_iv>, [[<minecraft:redstone>, <advgenerators:power_io>, <minecraft:redstone>],[<ic2:blockelectric:13>, <advgenerators:iron_wiring>, <ic2:blockelectric:13>], [<minecraft:redstone>, <advgenerators:iron_tubing>, <minecraft:redstone>]]);
recipes.addShaped("ctagev", <advgenerators:eu_output_ev>, [[<minecraft:redstone>, <advgenerators:power_io>, <minecraft:redstone>],[<ic2:blockelectric:11>, <advgenerators:iron_wiring>, <ic2:blockelectric:11>], [<minecraft:redstone>, <advgenerators:iron_tubing>, <minecraft:redstone>]]);
recipes.addShaped("ctaghv", <advgenerators:eu_output_hv>, [[<minecraft:redstone>, <advgenerators:power_io>, <minecraft:redstone>],[<ic2:blockelectric:10>, <advgenerators:iron_wiring>, <ic2:blockelectric:10>], [<minecraft:redstone>, <advgenerators:iron_tubing>, <minecraft:redstone>]]);
recipes.addShaped("ctagmv", <advgenerators:eu_output_mv>, [[<minecraft:redstone>, <advgenerators:power_io>, <minecraft:redstone>],[<ic2:blockelectric:9>, <advgenerators:iron_wiring>, <ic2:blockelectric:9>], [<minecraft:redstone>, <advgenerators:iron_tubing>, <minecraft:redstone>]]);
recipes.addShaped("ctaglv", <advgenerators:eu_output_lv>, [[<minecraft:redstone>, <advgenerators:power_io>, <minecraft:redstone>],[<ic2:blockelectric:8>, <advgenerators:iron_wiring>, <ic2:blockelectric:8>], [<minecraft:redstone>, <advgenerators:iron_tubing>, <minecraft:redstone>]]);
