...
recipes.addShaped(<extrautils2:bagofholding>, [[<minecraft:leather>, <minecraft:string>, <minecraft:leather>],[<minecraft:leather>, <ore:chest>, <minecraft:leather>], [<minecraft:leather>, <minecraft:leather>, <minecraft:leather>]]);
